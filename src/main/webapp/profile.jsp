            ...
            <form action="profile" method="post" class="auth-form">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="twilioToken" name="twilioToken" value="<%= profile.get("twilioToken") %>" required>
                    </div>
                    <div class="form-group">
                        <label for="twilioSender">Allowed sender ID (From number)</label>
                        <input type="tel" id="twilioSender" name="twilioSender" value="<%= profile.get("twilioSender") %>" required>
                    </div>
                </div>

                <button type="submit" style="background-color: var(--primary-color);">Save Changes</button>
            </form>
        </div>
    </div>
</body>
