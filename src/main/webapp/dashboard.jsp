            ...
            <div class="card">
                ...
                <form action="send-sms" method="post">
                    <div class="form-group">
                        ...
                        <input type="tel" id="from" name="from"
                ...
                <form action="dashboard" method="get" class="search-bar">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" id="searchFrom" name="searchFrom"
                            value="<%= request.getAttribute("searchFrom") != null ? request.getAttribute("searchFrom") : "" %>">
                    </div>
                    <div class="form-group mb-0">
                        <label for="searchTo">To</label>
                        <input type="text" id="searchTo" name="searchTo"
                            value="<%= request.getAttribute("searchTo") != null ? request.getAttribute("searchTo") : "" %>">
                    </div>
                    <div class="form-group mb-0">
                            ...
                            <% 
                                ...
                                if (smsList != null && !smsList.isEmpty()) {
                                    for (Object item : smsList) {
                                        ...
                                        String status = sms.get("status") != null ? (String) sms.get("status") : "unknown";
                                        String statusClass = status.toLowerCase().replaceAll("[^a-z0-9-]", "");
                            %>
                            <tr>
                                <td><%= sms.get("from") %></td>
                                ...
                                <td>
                                    <form action="delete-sms" method="post" style="margin:0;"
